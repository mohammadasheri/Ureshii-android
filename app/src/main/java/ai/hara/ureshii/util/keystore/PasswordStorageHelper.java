...
//        } catch (Exception ex) {
//            Timber.tag(LOG_TAG).e(ex, "PasswordStorage initialisation error:%s", ex.getMessage());
//        }
//
...
//                }
//                Timber.tag(LOG_TAG).d("Hardware-Backed Keystore Supported: %s", isHardwareBackedKeystoreSupported);
//            } catch (KeyStoreException | NoSuchAlgorithmException | UnrecoverableKeyException |
//                     InvalidKeySpecException | NoSuchProviderException ignored) {
//            }
//
//            return true;
//        }
...
//
//                if (publicKey == null) {
//                    Timber.tag(LOG_TAG).d("Error: Public key was not found in Keystore");
//                    return;
//                }
//
